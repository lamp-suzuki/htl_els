    ...
    <table class="item__list-table">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            <form class="js-delete-option" action="{{ route('manage.product.option.delete') }}" method="post">
              @csrf
...
<div class="modal fade" id="addOption" tabindex="-1" role="dialog" aria-labelledby="addOptionLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <form id="add-option-form" class="modal-content" action="{{ route('manage.product.option.add') }}" method="POST">
      @csrf
...
<div class="modal fade" id="editOption" tabindex="-1" role="dialog" aria-labelledby="editOptionLabel"
  aria-hidden="true">
  <div class="modal-dialog" role="document">
    <form id="edit-option-form" class="modal-content" action="{{ route('manage.product.option.edit') }}" method="POST">
      @csrf
      <div class="modal-header">
